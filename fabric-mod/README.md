...
- [ ] With `loggingEnabled: true`, confirm a color-coded message appears in chat and the same message appears in Minecraft's normal log stream for each prevented pickup/placement; with `false`, confirm both stay silent.
